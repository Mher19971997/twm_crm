...
const FilterOrganizationMenu = ({ openMenu, handleCloseMenu }) => {
  ...
  const submitHandler = async (e) => {
    ...
    console.log(filteredParams, "filteredParamsfilteredParams");
    setSearchParams(filteredParams);
    console.log(111, filteredParams);
  };
  return (
    <FilterConfigurator
      openMenu={openMenu}
...
FilterOrganizationMenu.propTypes = {
  openMenu: PropTypes.bool,
  handleCloseMenu: PropTypes.any,
};

export default FilterOrganizationMenu;